#%% Description
#
# PC_SR_UC refers to plate with circular cutout model with uncontrolled spatial randomness, using DiNN-NC framework
#
#%% Import Modules
...
for k in range(data_set):
    ...
    txt_cart    = 'C:\\Temp_Abaqus\\micro_meter_model\\random_hole_hollow_four_pp\\Composite_uniform_SDF_Cart_' + idx + '.dat'
    txt_stress  = 'C:\\Temp_Abaqus\\micro_meter_model\\random_hole_hollow_four_pp\\Composite_uniform_Stress_Cart_' + idx + '.dat'
    one_cart    = 'C:\\Temp_Abaqus\\micro_meter_model\\random_hole_hollow_four_pp\\One_SDF_Cart_' + idx + '.dat'
    one_stress  = 'C:\\Temp_Abaqus\\micro_meter_model\\random_hole_hollow_four_pp\\One_Stress_Cart_' + idx + '.dat'
