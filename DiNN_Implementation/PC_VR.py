#%% Description
#
# PC_VR refers to plate with circular cutout model with volume fraction randomness, using DiNN-NC framework
#
#%% Import Modules
...
# Uniform dimension for input data (Line 61-64 import data of this size)
n_x = 79
n_y = 79
...
for k in range(data_set):
    ...
    txt_cart    = 'C:\\Temp_Abaqus\\micro_meter_model\\fix_hole_hollow_small\\Composite_uniform_SDF_Cart_' + idx + '.dat'
    txt_stress  = 'C:\\Temp_Abaqus\\micro_meter_model\\fix_hole_hollow_small\\Composite_uniform_Stress_Cart_' + idx + '.dat'
    one_cart    = 'C:\\Temp_Abaqus\\micro_meter_model\\fix_hole_hollow_small\\One_SDF_Cart_' + idx + '.dat'
    one_stress  = 'C:\\Temp_Abaqus\\micro_meter_model\\fix_hole_hollow_small\\One_Stress_Cart_' + idx + '.dat'
