#%% Description
#
# SP_SR_UC refers to square packed reinforced composite model with uncontrolled spatial randomness, using DiNN-N framework
#
#%% Import Modules
...
for k in range(data_set):
    ...
    txt_cart   = 'C:\\Temp_Abaqus\\micro_meter_model\\fix_hole_composite_small_random_pp\\Composite_uniform_SDF_Cart_' + idx + '.dat'
    txt_stress = 'C:\\Temp_Abaqus\\micro_meter_model\\fix_hole_composite_small_random_pp\\Composite_uniform_Stress_Cart_' + idx + '.dat'
...
#%% Data Random Split       
X_train, X_test, Y_train, Y_test, P_train, P_test = train_test_split(data_cart_new, data_stress_new,data_property,test_size=0.2, random_state=47)
X_test, X_cv,   Y_test,   Y_cv,   P_test,  P_cv   = train_test_split(X_test,       Y_test,        P_test,      test_size=0.5, random_state=47)
