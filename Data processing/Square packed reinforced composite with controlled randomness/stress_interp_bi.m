function [stress_cart, property, DD] = stress_interp_bi(Cart_data,Elements,Nodes,stress_map,center)
...
circle1 = [center(1),center(2)];
circle2 = [center(3),center(4)];
circle3 = [center(5),center(6)];
circle4 = [center(7),center(8)];
