...
folder_path = 'C:\Temp_Abaqus\micro_meter_model\fix_hole_composite_small_random_pp\';
...
circle_x1 = 0.0020 + 0.0060*rand(1,1);
circle_y1 = 0.0020 + 0.0060*rand(1,1);

% Determine Location of 2nd circle

while 1
    temp_x = 0.0020 + 0.0060*rand(1,1);
    temp_y = 0.0020 + 0.0060*rand(1,1);
    
    if distance(temp_x,temp_y,circle_x1,circle_y1)<2.5*circle_r
        continue
    else
        circle_x2 = temp_x;
        circle_y2 = temp_y;
...
while 1
    ...
    if distance(temp_x,temp_y,circle_x1,circle_y1)<2.5*circle_r || distance(temp_x,temp_y,circle_x2,circle_y2)<2.5*circle_r
        continue
    else
        circle_x3 = temp_x;
        circle_y3 = temp_y;
...
while 1
    ...
    if distance(temp_x,temp_y,circle_x1,circle_y1)<2.5*circle_r || distance(temp_x,temp_y,circle_x2,circle_y2)<2.5*circle_r || distance(temp_x,temp_y,circle_x3,circle_y3)<2.5*circle_r
        continue
    else
        circle_x4 = temp_x;
        circle_y4 = temp_y;
