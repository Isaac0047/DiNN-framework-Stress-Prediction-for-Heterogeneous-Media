...
folder_path = 'C:\Temp_Abaqus\micro_meter_model\fix_hole_composite_small\';
...
%     K = 3 - 3.14*dw + 3.667*dw^2 - 1.527*dw^3; 
    ...
    for ii = 1:1:L_Cart
        ...
        Cart_dist(ii,1) = distance(circle_x,circle_y,Cart_data(ii,1),Cart_data(ii,2));
    ...
    [stress_cart,property,D] = stress_interp_bi(Cart_data,aba_elements,aba_nodes,stress_map,circle_x,circle_y,circle_r);
